...
namespace Discount.API.Controllers
{
    ...
    public class DiscountController : ControllerBase
    {
        ...
        {
            var discount = await this.repository.GetDiscount(productName);
        ...
        {
            return obj is DiscountController controller &&
                   EqualityComparer<IDiscountRepository>.Default.Equals(repository, controller.repository);
        }
    }
}
